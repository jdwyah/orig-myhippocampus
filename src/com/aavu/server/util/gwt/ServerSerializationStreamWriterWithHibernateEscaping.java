...
import com.google.gwt.user.server.rpc.impl.ServerSerializableTypeOracle;
	 ...
	 */
	public class ServerSerializationStreamWriterWithHibernateEscaping extends
	  ...
	  public ServerSerializationStreamWriterWithHibernateEscaping(
			  ...
			  if (type == boolean.class) {
				  ...
				  if(Hibernate.isInitialized(value)){
					  if(value instanceof ReallyCloneable){
						  System.out.println(value.getClass().getName()+" CGLIBBB!! Cloning");
						  System.out.println("value "+value);				  

						  writeObject(((ReallyCloneable)value).clone());
					  }else{
						  throw new CouldntFixCGLIBException(value.getClass()+" must implement ReallyCloneable");
					  }
				  }else{
					  System.out.println("WASN'T INITIALIZED ");
					  writeObject(null);
				  }
			  }
			  else {
	  ...
	  protected String getObjectTypeSignature(Object instance) {
	    if (shouldEnforceTypeVersioning()) {
	      return serializableTypeOracle.encodeSerializedInstanceReference(instance
	          .getClass());
	    } else {
