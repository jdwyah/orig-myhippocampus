...
public abstract class AbstractTopic  implements IsSerializable,java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTopic(User user, String title, String data, Date lastUpdated, Date created, boolean publicVisible, Set scopes, Subject subject, Set instances, Set types, Set occurences, Set associations) {
       this.user = user;
       this.title = title;
       this.data = data;
