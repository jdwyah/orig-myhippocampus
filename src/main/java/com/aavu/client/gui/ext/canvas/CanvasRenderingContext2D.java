...
/**
 * Wrapper Class to represent the 2D Rendering Context of a Canvas element. It implements all the
 * methods of the WhatWG specification but with some adaptations to better align with the Java
 * language.
 * 
...
public class CanvasRenderingContext2D {
	...
	/**
	 * Constructs a rendering context instance. This method is only called by the Canvas class.
	 * 
	 * @param canvas
	 *            the parent canvas for this context
	 * @param jsCtx
	 *            the wrapped JS context object
	 */
	...
	public void setFillStyle(String cssColor) {
		if (fillStyle == null || fillStyle.getStyleType() != CanvasDrawingStyle.COLOR
	...
	public CanvasDrawingStyle createLinearGradient(float x0, float y0, float x1, float y1) {
		return new CanvasDrawingStyle(CanvasDrawingStyle.GRADIENT, createLinearGradientImpl(x0, y0,
				x1, y1));
	}

	public CanvasDrawingStyle createRadialGradient(float x0, float y0, float r0, float x1,
			float y1, float r1) {
		return new CanvasDrawingStyle(CanvasDrawingStyle.GRADIENT, createRadialGradientImpl(x0, y0,
				r0, x1, y1, r1));
	}

	public CanvasDrawingStyle createPattern(Image img, String repetition) {
		return new CanvasDrawingStyle(CanvasDrawingStyle.PATTERN, createPatternImpl(img
				.getElement(), repetition));
	}

	public CanvasDrawingStyle createPattern(Canvas canvas, String repetition) {
		return new CanvasDrawingStyle(CanvasDrawingStyle.PATTERN, createPatternImpl(canvas
				.getElement(), repetition));
	}
	...
	public void drawImage(Image img, float sx, float sy, float sw, float sh, float dx, float dy,
			float dw, float dh) {
	...
	public void drawImage(Canvas cnv, float sx, float sy, float sw, float sh, float dx, float dy,
			float dw, float dh) {
