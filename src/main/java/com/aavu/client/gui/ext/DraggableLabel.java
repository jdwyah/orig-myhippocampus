...
public class DraggableLabel extends Label implements ClickListener, SourcesMouseEvents,
		RemembersPosition {
	...
	/**
	 * cancel the event, or you can't have a draggable widget in a draggable widget. (ie label on
	 * island)
	 */
