package com.aavu.client.gui.ext.canvas;

import com.google.gwt.core.client.GWT;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * Wrapper class for Canvas drawing styles. 3 types of styles are supported by the class: COLOR -
 * the string representation of a CSS Color element PATTERN - pattern as created by
 * CanvasRenderingContext2D.createPattern() GRADIENT - gradient as created by
 * CanvasRenderingContext2D.createLinearGradient() or createRadialGradient() This class was created
 * to provide a cleaner, type-safer way to access canvas drawing styles.
 * 
...
public class CanvasDrawingStyle {
	...
	/**
	 * Constructs a gradient or pattern style This constructor may only be called by the appropriate
	 * methods of the CanvasRenderingContext2D class.
	 * 
	 * @param styleType
	 *            GRADIENT or PATTERN to designate the style
	 * @param drawingStyle
	 *            The JS Object to wrap
	 */
	 ...
	 * 
	 * @param cssColor
	 *            the string representing the CSS color
	 */
	...
	/**
	 * Compares a CanvasDrawingStyle instance explicitly. A Color style is equal to an other style
	 * if their string representation equals to eachother. A Pattern or Gradient style equals to
	 * another if their wrapped JS objects equal.
	 * 
	 * @param style
	...
	/**
	 * Adds stop colors at specific offsets for gradient styles. This method is the direct wrapper
	 * of the CanvasGradient.addStopColor JS method.
	 * 
	 * @param offset
	 *            The offset to set the stop color
	 * @param cssColor
	 *            The stop color
	 */
	public void addColorStop(float offset, String cssColor) {
		if (styleType != GRADIENT)
			throw new UnsupportedOperationException(
					"This operation is only supported for GRADIENT styles");
	...
	/**
	 * Returns the wrapped JS object. Used by the CanvasRenderingContext2D wrapper to access the
	 * wrapped gradient and pattern objects
	 * 
	 * @return JS object
	 */
