...
public class Zoomer extends SimplePanel implements MouseListener {
	...
	/**
	 * It seems redundant to have this absPanel as a member instead of just extending AbsolutePanel,
	 * but positioning things on the map absolutely seems to only really work with SimplePanel's
	 * that have Style AbsolutePanel
	 * 
	 * @param guiManager
	 */
	public Zoomer(final GUIManager guiManager) {
	...
	public void onMouseUp(Widget sender, int x, int y) {
		...
		guiManager.zoomTo(convertToScale(i));
