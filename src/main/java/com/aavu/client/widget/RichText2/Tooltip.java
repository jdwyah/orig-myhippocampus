...
/**
 * This class represent a tooltip that can be setup with css. The used css stylename is Tooltip. A
 * typical use is: <code><pre>
...
public class Tooltip extends MouseListenerAdapter {
	 ...
	 * 
	 * @param text
	 *            The tooltip text. It should not be null.
	 * @param button
	 */
	public Tooltip(String text, ImageButton button) {
		...
		tooltip.addStyleName("H-BlueFade");
	}
