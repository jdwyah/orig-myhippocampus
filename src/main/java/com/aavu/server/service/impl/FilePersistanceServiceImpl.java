...
public class FilePersistanceServiceImpl implements FilePersistanceService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.aavu.server.service.FilePersistanceService#saveFile(java.lang.String, int, byte[],
	 *      java.lang.String, com.aavu.client.domain.User)
	 */
	public String saveFile(String contentType, long topicID, byte[] file, String filename, User user)
		...
		try {
			...
			if (awsResp.connection.getResponseCode() != HttpURLConnection.HTTP_OK) {
				...
				throw new HippoInfrastructureException(FileUploadController.ERR_STR
						+ " File Upload failure " + awsResp);
			}

			// TODO remove this check
			ListBucketResponse listresp = awsConnection.listBucket(
					awsConnection.getDefaultBucket(), null, null, null, null);
	 ...
	 * @see com.aavu.server.service.FilePersistanceService#saveFileToTopic(java.lang.String, int,
	 *      java.io.InputStream, java.lang.String, com.aavu.client.domain.User)
	 */
	public void saveFileToTopic(PersistedFile file, Topic topic, User user) throws HippoException {
		...
		String key = saveFile(file.getContentType(), topic.getId(), file.getContent(), file
				.getFilename(), user);
	...
	/**
	 * Get the file. Check to make sure the key starts with username. TODO is that secure enough?
	 * 
	 */
	...
	/**
	 * Delete the file. Check to make sure the key starts with username. TODO is that secure enough?
	 * 
	 */
