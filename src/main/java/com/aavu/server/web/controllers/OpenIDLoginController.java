...
public class OpenIDLoginController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest req,
        ...
        if ((password != null) && (password.length() > 0)) {
            System.out.println("Attempting to authenticate using username/password "+formLoginUrl);
            System.out.println("user: "+req.getParameter("j_username")+" "+req.getParameter("j_password"));
