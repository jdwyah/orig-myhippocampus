...
public class InvitationServiceImplTest extends BaseTestWithTransaction {
	...
	protected void onSetUpInTransaction() throws Exception {
		...
		System.out.println("invitationService" + invitationService + " "
				+ invitationService.getClass());
	...
	public void testCreateAndSendInvitation() throws HippoBusinessException,
			HippoInfrastructureException {
		...
		// Fix was to bump all subscriptions in DB up 1 row, (1-4) instead of (0-3) so that there is
		// no 0 row.
		User u2 = new User();
		u2.setUsername("u2");
